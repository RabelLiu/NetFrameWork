package com.volley.request.cache.imageCache;
...
import com.volley.disklrucache.DiskLruCache;
import com.volley.disklrucache.MD5Utils;
...
public class ImageCacheUtil implements ImageCache {
    ...
    public ImageCacheUtil(Context context) {
        ...
        try {
            // 获取DiskLruCahce对象
            // mDiskLruCache =
            // DiskLruCache.open(getDiskCacheDir(MyApplication.newInstance(),
            // "xxxxx"), getAppVersion(MyApplication.newInstance()), 1,
            // DISKMAXSIZE);
            mDiskLruCache = DiskLruCache.open(getDiskCacheDir(context.getApplicationContext(), "microcell"),
